...
class NeuralLinearUCB:
	...
	def validate_model(self, exp_idx, t_idx, contexts_val, psd_rewards_val):
		...
		with open('linear_neural_UCB/outputs_val_' + str(exp_idx) + str(t_idx) + '.pkl', 'wb') as f:
			pickle.dump(outputs, f)

		with open('linear_neural_UCB/labels_val_' + str(exp_idx) + str(t_idx) + '.pkl', 'wb') as f:
...
if __name__ == '__main__':
	...
	path = "out/logs/demo/linear_neural_UCB" + str(args.exp_idx)
	fr = open(path,'w')
	for i in regrets:
		fr.write(str(i))
		fr.write("\n")
	...
	with open('linear_neural_UCB/linear_neural_UCB_outputs' + str(args.exp_idx) + '.pkl', 'wb') as f:
		pickle.dump(outputs, f)

	with open('linear_neural_UCB/linear_neural_UCB_labels' + str(args.exp_idx) + '.pkl', 'wb') as f:
		pickle.dump(labels, f)